...
import 'package:heart_failure_prediction_app/view/health_schedule/count_up_time.dart';
import 'package:stop_watch_timer/stop_watch_timer.dart';

class Count_Down_Timer extends StatefulWidget {
  const Count_Down_Timer({ Key? key }) : super(key: key);
    static Future<void> navigatorPush(BuildContext context) async {
    return Navigator.push<void>(
      context,
      MaterialPageRoute(
        builder: (_) => Count_Down_Timer(),
      ),
    );
  }

  @override
  _Count_Down_TimerState createState() => _Count_Down_TimerState();
}
...
class _Count_Down_TimerState extends State<Count_Down_Timer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Health CountDown StopWatch'),
      ),
      body: Center(
        child: Column(
